      ...
      <Grid container>
        ...
        <Grid item xs={12} container>
          <Grid item container xs={12} md={6}>
            <Grid item xs={12}>
              <Box mb={2}>
                <Typography variant="h3">EcoSattva Training</Typography>
              </Box>
            </Grid>
            <Grid item xs={12}>
              <Box mb={2}>
          ...
          <Grid item container xs={12} md={6}>
            ...
            <Grid item container justify="center" xs={12}>
              <Box my={3}>
                <Typography variant="h4">
                  <a href="https://oneearthsangha.org/programs/ecosattva-training/?utm_source=Sangha&utm_campaign=dc46d171d2-EST19_ANNOUNCE&utm_medium=email&utm_term=0_346c404fc8-dc46d171d2-182641077&mc_cid=dc46d171d2&mc_eid=dc81671117">
                    Find out more here
                  </a>
                </Typography>
              </Box>
